...
export default {
 ...
 methods: {
      async getTrainings() {
        try {
          const response = await fetch('http://localhost:8080/trainings/table');
        ...
        async deleteTraining(trainingrId) {
          ...
          try {
            await fetch(`http://localhost:8080/trainings/table/${trainingId}`, {
              method: 'DELETE',
              headers: {
        ...
        addTraining() {
          fetch("http://localhost:8080/trainings/table", {
            method: "POST",
            headers: {
              "Content-Type": "application/json"
            },
