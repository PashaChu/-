    ...
    <div class="table-box">
        <div class="table-wrapper">
          <table class="fl-table">
            ...
            <tbody>
              <tr>
                <td contenteditable="true" @input="updateClientData('surname', $event)">{{ clientData.surname }}</td>
                <td contenteditable="true" @input="updateClientData('name', $event)">{{ clientData.name }}</td>
                <td contenteditable="true" @input="updateClientData('patronymic', $event)">{{ clientData.patronymic }}</td>
        ...
        addClient() {
          ...
          fetch("http://localhost:8080/clients/table", {
            ...
            body: JSON.stringify({
              ...
              patronymic: this.clientData.patronymic,
